...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="<?= base_url('OwnerPanel/Transaksi'); ?>"><i class="fa fa-truck text-white"
          aria-hidden="true"></i>
        <span>Transaksi</span></a>
    </li>
    <li class="active"><a href="<?= base_url('OwnerPanel/Item'); ?>"><i class="fa-solid fa-cube text-white"></i>
        <span>Item</span></a> </li>
    <li class="active"><a href="<?= base_url('OwnerPanel/Pembeli'); ?>"><i class="fa fa-users text-white"
          aria-hidden="true"></i>
        <span>Pembeli</span></a>
    </li>
    <li class="active"><a href="<?= base_url('OwnerPanel/Laporan'); ?>"><i class="fa-solid fa-file-pdf"
          style="color: #ffffff;"></i> <span>Laporan
          Penjualan</span></a> </li>
    <li class="active"><a href="<?= base_url('OwnerPanel/Admin'); ?>"><i class="fa fa-users text-white"
          aria-hidden="true"></i>
        <span>Admin</span></a>
    </li>
