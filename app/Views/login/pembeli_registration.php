  ...
  <div id="loginbox">
    <form id="loginform" class="form-vertical" method="POST" action="<?= base_url('Auth/Pembeli/Registration'); ?>">
      ...
      <div class="control-group">
        <div class="controls">
          <div class="main_input_box">
            <span class="add-on"><i class="icon-user"></i></span><input type="text" name="fullname" placeholder="Fullname" />
          </div>
        </div>
      </div>
      <div class="control-group">
      ...
      <div class="control-group">
        <div class="controls">
          <div class="main_input_box">
            <span class="add-on"><i class="icon-lock"></i></span><input type="password" name="confirmPassword" placeholder="Konfirmasi Password" />
          </div>
        </div>
      </div>
      <div class="form-actions">
        <span class="pull-left"><a href="<?= base_url(''); ?>" class="flip-link btn btn-inverse">Kembali ke Halaman
            Depan</a><a href="<?= base_url('Auth/Pembeli'); ?>" class="flip-link btn btn-inverse">Sudah punya akun?
