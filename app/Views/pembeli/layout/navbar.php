...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li class=""><a title="" href="<?= base_url('PembeliPanel/Settings'); ?>"><i class="icon icon-cog"></i> <span class="text">Informasi Setting</span></a></li>
    <li class=""><a title="" href="<?= base_url('Auth/Pembeli/Destroy'); ?>"><i class="icon icon-share-alt"></i> <span class="text">Logout</span></a>
    </li>
  </ul>
</div>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li> <a href="<?= base_url('PembeliPanel/KategoriItem'); ?>"><i class="fa fa-cubes text-white" aria-hidden="true"></i>
